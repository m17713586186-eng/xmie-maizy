...
const capabilities = ['AI 视频生成', '分镜设计', '视频剪辑', '后期调色', '声音设计', '视觉叙事']

export default function About() {
  return (
    <div className="about-page" id="top">
      <section className="page-shell about-hero">
        <p className="kicker">02 / ABOUT THE CREATOR</p>
        <Reveal><h1>用 AI 拓展想象，<br /><span>用电影语言完成表达。</span></h1></Reveal>
      </section>

      <section className="about-portrait page-shell">
        <Reveal className="portrait-frame"><img src="/images/portrait.jpg" alt="AI 影视创作者麦曾毅的个人头像" /></Reveal>
        <div className="portrait-caption"><span>麦曾毅</span><span>AI 影视创作者 · AIGC 短片导演 · 影视后期制作</span></div>
      </section>
      ...
      <section className="about-content page-shell">
        ...
        <div className="bio-copy">
          <Reveal>
            <p className="bio-lead">我是麦曾毅，一名 AI 影视创作者、AIGC 短片导演与影视后期制作者。</p>
